...
describe('GET /v1/student', () => {
  ...
  describe('Login', () => {
    it('[Success] Valid crendetials', async () => {
    ...
    it('[Failed] Invalid email', async () => {
      const res = await request(app).get('/v1/student/login?email=a0000001@tec.mx&password=Abc123456')
